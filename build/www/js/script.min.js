            ...
            _createClass(a, [
                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        if(settings.notifications.value === true && LoggedIn === true) {try {new Notification("Room ID: " + Room_ID, { body: date + " | " + this.userPublic.name + ": " + text, icon: "./img/bonzi/__closeup/" + this.userPublic.color + ".png" })} catch {}};
                        ...
                        this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").css("display", "block"),
                            ...
                            if (this.userPublic.voice == "sam") {
                                ...
                                var voice2;
                                this.userPublic.a = new Audio("https://mespeak-engine.onrender.com/voiceforge?text=" + encodeURIComponent(a) + "&voice="+ encodeURIComponent(replaceAll(this.userPublic.voice,"voiceforge:","")));
                                this.userPublic.a.play();
                                this.userPublic.a.onended = function() {
                                    d.clearDialog()
                                }
